...
let Formats = [
	...
	},
	{
		name: "[Gen 7] RU",
		threads: [
			`&bullet; <a href="https://www.smogon.com/forums/threads/3646393/">RU Metagame Discussion</a>`,
		...
		unbanlist: ['Drought'],
		onBegin: function () {
			if (this.rated) this.add('html', `<div class="broadcast-blue"><strong>RU is currently suspecting Stakataka! For information on how to participate check out the <a href="https://www.smogon.com/forums/threads/3646393/">suspect thread</a>.</strong></div>`);
		},
	},
	{
		name: "[Gen 7] NU",
		threads: [
			`&bullet; <a href="https://www.smogon.com/forums/threads/3646596/">NU Metagame Discussion</a>`,
		...
		onBegin: function () {
			if (this.rated) this.add('html', `<div class="broadcast-blue"><strong>NU is currently suspecting Vanilluxe! For information on how to participate check out the <a href="https://www.smogon.com/forums/threads/3646596/">suspect thread</a>.</strong></div>`);
		},
	},
	{
		name: "[Gen 7] PU",
	...
	},
	{
		...
		banlist: [
			'Arceus', 'Dialga', 'Gengar-Mega', 'Giratina', 'Groudon', 'Ho-Oh', 'Jirachi', 'Kangaskhan-Mega', 'Kyogre', 'Kyurem-White',
	...
	},
	{
		...
		mod: 'gen2',
		ruleset: ['Pokemon', 'Standard', 'Item Clause'],
		banlist: ['Uber'],
	},
	...
	},
	{
		...
		ruleset: ['Pokemon', 'Species Clause', 'Nickname Clause', 'Moody Clause', 'OHKO Clause', 'Evasion Moves Clause', 'Accuracy Moves Clause', 'Swagger Clause', 'Endless Battle Clause', 'HP Percentage Mod', 'Cancel Mod', 'Team Preview'],
		banlist: [
			'Illegal', 'Unreleased', 'Arceus', 'Blaziken', 'Darkrai', 'Deoxys', 'Deoxys-Attack', 'Deoxys-Defense',
	...
	},
	{
		...
		mod: 'gen7',
		ruleset: ['Pokemon', 'Allow CAP', 'Endless Battle Clause', 'Team Preview', 'HP Percentage Mod', 'Cancel Mod'],
	},
	{
		name: "[Gen 7] Inverse Battle",
		desc: `Based on an Inverse battle format introduced in Pok&eacute;mon X and Y.`,
	...
	{
		name: "[Gen 7] MS Exclusive: The Pokémon Land Gang",
		desc: "Our friends at the Pokémon Land are waiting for you! Join them in the non-stop endless fun of battles that you've never get bored again!",

		mod: 'pkland',
		team: 'randomPKLand',
		ruleset: ['HP Percentage Mod', 'Cancel Mod', 'Sleep Clause Mod'],
		onBegin: function () {
			this.add('raw|<b>READY!</b>!');
			this.add('message', 'It\s a bunch of random Pokémon!');
			this.add(`raw|<div class='broadcast-green'><b>A website about this meta comes soon Spring 2019.</b></div>`);
		},
		onSwitchIn: function (pokemon) {
			let name = toId(pokemon.illusion ? pokemon.illusion.name : pokemon.name);
			if (this.getTemplate(name).exists) {
	...
	{
		section: "Pokémon Revelation",
		column: 6,
	},
	{
		name: "[Gen 7 Revelation] Singles No Restrictions",

		mod: 'revelation',
		ruleset: ['Pokemon', 'Allow CAP', 'Endless Battle Clause', 'Team Preview', 'HP Percentage Mod', 'Cancel Mod'],
	},
	{
		name: "[Gen 7 Revelation] OU",

		mod: 'revelation',
		ruleset: ['Pokemon', 'Allow CAP', 'Standard', 'Endless Battle Clause', 'Team Preview', 'HP Percentage Mod', 'Cancel Mod'],
		banlist: ['Uber', 'Arena Trap', 'Power Construct', 'Shadow Tag', 'Baton Pass'],
	},
	{
		name: "[Gen 7 Revelation] Ubers",

		mod: 'revelation',
		ruleset: ['Pokemon', 'Allow CAP', 'Standard', 'Endless Battle Clause', 'Team Preview', 'HP Percentage Mod', 'Cancel Mod', 'Mega Rayquaza Clause'],
		banlist: ['Baton Pass'],
	},
	{
		name: "[Gen 7 Revelation] Balanced Hackmons",

		mod: 'revelation',
		ruleset: ['Pokemon', 'Allow CAP', 'Ability Clause', 'OHKO Clause', 'Evasion Moves Clause', 'CFZ Clause', 'Endless Battle Clause', 'Team Preview', 'HP Percentage Mod', 'Cancel Mod'],
		banlist: ['Groudon-Primal', 'Liberation', 'Arena Trap', 'Huge Power', 'Illusion', 'Innards Out', 'Magnet Pull', 'Moody', 'Parental Bond', 'Protean', 'Psychic Surge', 'Pure Power', 'Shadow Tag', 'Stakeout', 'Water Bubble', 'Wonder Guard', 'Gengarite', 'Chatter', 'Comatose + Sleep Talk'],
	},
	{
		name: "[Gen 7 Revelation] Custom Game",
