...
exports.BattleScripts = {
	moveHit: function (target, pokemon, move, moveData, isSecondary, isSelf) {
			...
			if (target) {
				...
				if (moveData.field.weather) {
					hitResult = this.field.setWeather(moveData.field.weather, pokemon, move);
					didSomething = didSomething || hitResult;
				}
				if (moveData.field.terrain) {
					hitResult = this.field.setTerrain(moveData.field.terrain, pokemon, move);
					didSomething = didSomething || hitResult;
				}
				if (moveData.field.pseudoWeather) {
					hitResult = this.field.addPseudoWeather(moveData.field.pseudoWeather, pokemon, move);
					didSomething = didSomething || hitResult;
				}
